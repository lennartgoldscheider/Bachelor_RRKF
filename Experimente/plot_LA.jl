...
fig = begin
    ...
    #Legende am Rand zur besseren Erkennung welcher Filter welchen Graph darstellt
    ...
    Label(grid_plot[1, :, Bottom()], "low-rank dimension ", fontsize=BASE_FONTSIZE-1, font="Times New Roman regular", halign = :center, valign=:bottom, padding=(5, 5, 0, 0))
